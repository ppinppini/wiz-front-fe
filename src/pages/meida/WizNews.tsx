    ...
    return (
        <div className="flex flex-col items-center bg-black ">
            ...
            <div className="w-[1100px] h-[1590.5px] mx-[25.1em] pt-[4.625em] relative">
                {/* 페이지 로케이터 */}
                <PageLocator pagePath="> MEDIA >" currentPage="wiz 뉴스" /> {/* 탭 구현 */}
          ...
          {news.map((item) => (
            <NewsCard key={item.artcSeq} article={item} />
                ...
                {/* 뉴스 상세 모달 */}
                {selectedArticle && <NewsDetailModal article={selectedArticle} isOpen={isModalOpen} onClose={() => setModalOpen(false)} />}
                {/* 페이지네이션 */}
