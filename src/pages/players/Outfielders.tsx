      ...
      <div className='flex flex-col justify-center w-full'>
        <section className='z-40 w-full content_block pb-[300px] -mt-[100px]'>
            <div className='mt-[40px]'>
              <TabMenuBar tabs={playerTabs} tabtitle='외야수'/>
            </div>
            <div className='flex flex-col items-center mx-auto'>
              <h4 className='text-2xl text-white mt-[80px] w-[1240px]'>외야수</h4>
              <div className='mt-[100px] content_detail w-[1240px]'>
                <PlayerOutfielderCardList />
              </div>
            </div>
        </section>
        ...
        {isSticky && (
          ...
          >
            <TabMenuNavbar menuItems={playerTabs} tabtitle='외야수'/>
          </div>
        )}
