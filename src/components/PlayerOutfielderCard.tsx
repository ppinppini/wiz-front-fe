...
interface PlayerCardProps {
    ...
    imageUrl: string;
    pcode: string;
    playerData: TPlayerOutfielderProps;
}

const PlayerOutfielderCard: React.FC<PlayerCardProps> = ({ number, name, imageUrl, pcode, playerData }) => {
...
export default PlayerOutfielderCard;
