...
const Nav = () => {
    ...
    return (
        <>
            <nav ref={navRef} className=" z-50 w-full group border-2 ">
                {/* 지속적인 영역 */}
            <div
                ...
                <div className="flex items-end ">
                    <ul className="flex gap-14 items-end text-[17px] ">
                        <li className="relative ">
                            ...
                            <ul className="  absolute left-0 top-full hidden text-[14px] group-hover:block group-hover:text-white  space-y-2  mt-2 w-20 ">
                                <li>
                                    <Link to={"/ktwiz/about"}>KT Wiz는?</Link>
                                </li>
                                <li>
                                    <Link to={"/ktwiz/history"}>구단 BI</Link>
                                </li>
                        ...
                        <li className="relative">
                            ...
                            <ul className="absolute left-0 top-full hidden text-[14px] group-hover:text-white  group-hover:block space-y-2 mt-2 w-36 ">
                                <li>
                        ...
                        <li className="relative">
                            ...
                            <ul className="absolute left-0 top-full hidden text-[14px] group-hover:text-white  group-hover:block space-y-2 mt-2 w-20">
                                <li>
                                    <Link to={"/game/schedule"}>정규리그</Link>
                                </li>
                                <li>
                                    <Link to={"/game/schedule"}>퓨처스리그</Link>
                                </li>
                            </ul>
                        </li>
                        <li className="relative">
                        ...
                        <li className="relative">
                            ...
                            <ul className="absolute left-0 top-full hidden text-[14px] group-hover:text-white  group-hover:block space-y-2 mt-2 w-28">
                                <li>
